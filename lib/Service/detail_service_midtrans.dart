...
class _DetailServiceMidtransPageState
      ...
      child: Column(
        ...
        children: [
          ...
          _summaryRow("Subtotal", "Rp 1",
              isTotal: true, color: const Color(0xFF0041c3), scale: scale),
        ],
      ),
    );
  }
  ...
  Widget _discountButton(int discount, String label) {
    return Expanded(
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: selectedDiscount == discount ? const Color(0xFF0041c3) : Colors.grey[300],
  ...
  Widget _paymentItem(IconData icon, String label) {
    return ListTile(
      leading: Icon(icon, color: const Color(0xFF0041c3)),
