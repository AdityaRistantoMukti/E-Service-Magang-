  ...
  Future<void> _getUltraHighAccuracyLocation() async {
    ...
    try {
      ...
      for (int i = 0; i < sampleCount; i++) {
        setState(() {
          _alamat = "Mengkalibrasi GPS (${((i + 1) / sampleCount * 100).round()}%)...";
        });
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Text("$accuracyText (±${finalPosition.accuracy.toStringAsFixed(0)}m)"),
              ],
            ),
  ...
  Future<String> _getAddressFromCoordinates(double lat, double lng) async {
    ...
    try {
      ...
      if (placemarks.isNotEmpty) {
        ...
        if (p.postalCode != null && p.postalCode!.isNotEmpty) components.add(p.postalCode!);
    ...
    if (apiKey.isNotEmpty) {
      try {
        ...
        final response = await http.get(googleUrl).timeout(const Duration(seconds: 5));
    ...
    if (bestAddress.isEmpty) {
      bestAddress = "Lat: ${lat.toStringAsFixed(6)}, Lng: ${lng.toStringAsFixed(6)}";
    }
    
    return bestAddress;
  }

  Future<void> _updateAddressFromLatLng(LatLng latLng, {bool moveMap = false}) async {
    setState(() {
      _loading = true;
      _currentLatLng = latLng;
    });

    _alamat = await _getAddressFromCoordinates(latLng.latitude, latLng.longitude);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Detail Alamat", style: TextStyle(color: Colors.white, fontSize: 18)),
                            ...
                            CircleLayer(
                              circles: [
                                ...
                                CircleMarker(
                                  ...
                                  radius: _currentPosition!.accuracy.clamp(5, 100),
                                  color: const Color(0xFF0041c3).withOpacity(0.1),
                                  borderStrokeWidth: 2,
                                  borderColor: const Color(0xFF0041c3).withOpacity(0.3),
                                ),
                              ],
                            ),
                        ],
                        ...
                        child: Column(
                          children: [
                              ...
                              child: Column(
                                children: [
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      final zoom = (_mapController.camera.zoom + 1).clamp(12.0, 22.0);
                            ...
                            FloatingActionButton(
                              mini: true,
                              onPressed: _isGettingLocation ? null : _getUltraHighAccuracyLocation,
                              ...
                              child: _isGettingLocation
                                  ? const SizedBox(
                                      ...
                                      child: CircularProgressIndicator(
                                        strokeWidth: 2,
                                        valueColor: AlwaysStoppedAnimation<Color>(const Color(0xFF0041c3)),
                                      ),
                                    )
                                  : Icon(
                                      Icons.gps_fixed,
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(0xFF0041c3).withOpacity(0.05),
                            borderRadius: BorderRadius.circular(8),
                            border: Border.all(color: const Color(0xFF0041c3).withOpacity(0.2)),
                          ),
                          child: Row(
                            children: [
                              ...
                              Transform.scale(
                                ...
                                child: Switch(
                                  value: jadikanUtama,
                                  onChanged: (v) => setState(() => jadikanUtama = v),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: 200,
                          child: Text(
                            _isGettingLocation ? _alamat : "Memuat alamat...",
                            style: const TextStyle(
                              fontSize: 13,
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              if (icon != null) ...[
                Icon(icon, size: 16, color: const Color(0xFF0041c3)),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
                borderSide: const BorderSide(color: const Color(0xFF0041c3), width: 1.5),
              ),
              contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8),
              isDense: true,
            ),
