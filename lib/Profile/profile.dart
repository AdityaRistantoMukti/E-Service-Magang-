  ...
  Future<void> _loadVoucherCount() async {
    ...
    if (id != null) {
      try {
        ...
        final userVouchers = vouchers.map((json) => UserVoucher.fromJson(json)).toList();
        setState(() {
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              left: 16,
              right: 16,
              child: _buildProfileCard(context, nama, id, userData),
            ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 24),
                    _contactTile(
                      const Icon(Icons.support_agent, color: const Color(0xFF0041c3)),
                      '085942001720',
                      Icons.chat,
                      onTrailingTap: () async {
...
Widget _buildProfileCard(BuildContext context, String nama, String id, Map<String, dynamic>? userData) {
            ...
            Stack(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ClipOval(
                    child: (userData?['cos_gambar'] != null && userData!['cos_gambar'].isNotEmpty)
                        ? CachedNetworkImage(
                            imageUrl: "${ApiConfig.storageBaseUrl}${userData!['cos_gambar']}",
                            fit: BoxFit.cover,
                            placeholder: (context, url) => Center(
                              child: CircularProgressIndicator(
                                strokeWidth: 2,
                                valueColor: AlwaysStoppedAnimation<Color>(tierInfo.textColor.withOpacity(0.7)),
                              ),
                            ),
...
Widget _buildTierIcon(String label) {
  ...
  Widget _infoTile(IconData icon, String label, String value) {
   ...
   Widget _contactTile(Widget leadingIcon, String title, IconData trailingIcon, {Color color = const Color(0xFF0041c3), VoidCallback? onTrailingTap}) {
    return Container(
