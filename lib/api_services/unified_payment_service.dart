...
class UnifiedPaymentService {
    ...
    try {
      await PaymentService.startMidtransPayment(
        ...
        onTransactionFinished: (result) async {
          print('[UnifiedPayment] Payment Result - Status: $result');
          ...
          if (PaymentService.isTransactionSuccess(result)) {
            ...
            print('[UnifiedPayment] Payment failed: $errorMessage');
            onFailure(errorMessage);
          }
        },
      );
    } catch (e) {
      print('[UnifiedPayment] Error starting payment: $e');
      onFailure('Error: $e');
    }
  }
  ...
  static Future<void> _handleServicePaymentSuccess(
    ...
    try {
      ...
      print('[UnifiedPayment] Service transaction created successfully');
    } catch (e) {
      print('[UnifiedPayment] Failed to create service transaction: $e');
      rethrow;
    }
  }
  ...
  static Future<void> _handleProductPaymentSuccess(
    ...
    try {
      ...
      print('[UnifiedPayment] Product payment processed successfully');
    } catch (e) {
      print('[UnifiedPayment] Failed to process product payment: $e');
      rethrow;
    }
  }
