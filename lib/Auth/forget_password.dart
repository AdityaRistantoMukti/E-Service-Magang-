  ...
  Future<void> _sendVerificationCode() async {
    ...
    if (username.isEmpty || phone.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Username dan nomor HP wajib diisi')));
      return;
    }
    ...
    try {
      final result = await ForgetPasswordService.sendVerificationCodeByUsername(username, phone);
  ...
  Widget _buildTextField({
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: const Color(0xFF1976D2).withOpacity(0.15),
        prefixIcon:
