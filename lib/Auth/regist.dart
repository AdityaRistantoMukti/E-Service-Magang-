...
class _AuthPageState extends State<AuthPage> {
        ...
        return FadeTransition(
          ...
          child: SlideTransition(
            position: Tween<Offset>(
              begin: const Offset(-0.04, 0), // dari kiri ke kanan (kebalikan Login)
              end: Offset.zero,
            ).animate(curved),
            child: child,
          ),
  ...
  Future<void> _goToLogin() async {
    ...
    await Future.delayed(const Duration(milliseconds: 240)); // tunggu indikator geser
    if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    final Color blue = const Color(0xFF0041c3);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: _buildSegmentedSwitch(screenSize, blue, light),
                          ),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildTextField('Nama Lengkap', false, blue: blue),
                                  SizedBox(height: screenSize.height * 0.02),
                                  _buildTextField('Username', false, icon: Icons.person, blue: blue),
                                  SizedBox(height: screenSize.height * 0.02),
                                  _buildTextField('Nomor HP', false, icon: Icons.phone, blue: blue),
                                  SizedBox(height: screenSize.height * 0.02),
                                  _buildTextField('Tanggal Lahir', false, icon: Icons.calendar_today, blue: blue),
                                ],
                              ),
                            ),
                            SizedBox(height: screenSize.height * 0.02),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: screenSize.height * 0.02),
                                  _buildTextField('Konfirmasi Kata Sandi', true, blue: blue),
                                ],
                              ),
                            ),
                          ] else ...[
                          ...
                          ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor: isLogin ? Colors.white : blue,
                              foregroundColor: isLogin ? blue : Colors.white,
                              ...
                              try {
                                ...
                                if (result['success'] == true) {
                                  ...
                                  Navigator.pushAndRemoveUntil(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const HomePage(isFreshLogin: true),
                                    ),
                                    (route) => false,
                                  );
                                } else {
                  ...
                  child: InkWell(
                    ...
                    child: Center(
                      child: AnimatedDefaultTextStyle(
                        ...
                        curve: Curves.easeOut,
                        style: GoogleFonts.poppins(
                          color: isLogin ? blue : Colors.white,
                          fontWeight: FontWeight.w600,
                          fontSize: screenSize.width * 0.04,
                          letterSpacing: 0.2,
                        ),
    ...
    return TextField(
      ...
      onTap: isDateField
          ? () async {
              ...
              if (pickedDate != null) {
                controller?.text = DateFormat('dd-MM-yyyy').format(pickedDate); // UI
                tglLahirAsli = DateFormat('yyyy-MM-dd').format(pickedDate);    // backend
              }
            }
          : null,
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: isPassword
            ...
            : (icon != null
                ? Icon(icon, color: blue, size: screenSize.width * 0.05)
                : null),
