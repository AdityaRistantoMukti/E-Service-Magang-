...
class _LoginScreenState extends State<LoginScreen> {
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  isLogin ? Colors.white : const Color(0xFF0041c3),
                              foregroundColor:
                                  isLogin ? const Color(0xFF0041c3) : Colors.white,
  ...
  Widget _buildTextField(String hint, bool isPassword, {IconData? icon}) {
    ...
    return Semantics(
      label: hint == 'username' ? 'Masukkan nama pengguna' : 'Masukkan kata sandi',
      textField: true,
      child: TextField(
