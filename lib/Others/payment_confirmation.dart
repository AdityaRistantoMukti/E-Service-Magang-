...
class _PaymentConfirmationPageState extends State<PaymentConfirmationPage> {
  ...
  Widget build(BuildContext context) {
    final bankInfo = widget.selectedBank != null ? bankDetails[widget.selectedBank] : null;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.paymentMethod == "Transfer Bank" && bankInfo != null) ...[
              Container(
                width: double.infinity,
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.account_balance, color: Colors.green[600], size: 24),
                        const SizedBox(width: 8),
                        Text(
                          'Informasi Transfer',
                          style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Divider(),
                          _buildBankDetail('Nomor Rekening', bankInfo['accountNumber']!),
                          const Divider(),
                          _buildBankDetail('Atas Nama', bankInfo['accountName']!),
                        ],
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          Clipboard.setData(ClipboardData(text: bankInfo['accountNumber']!));
                          CustomDialog.show(
                            context: context,
                            icon: Container(
                              padding: const EdgeInsets.all(16),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _buildInstruction(1, 'Buka aplikasi banking atau m-banking Anda'),
                    _buildInstruction(2, 'Pilih menu transfer'),
                    _buildInstruction(3, 'Masukkan nomor rekening tujuan di atas'),
                    _buildInstruction(4, 'Masukkan nominal pembayaran yang sesuai'),
                    _buildInstruction(5, 'Pastikan detail transfer sudah benar'),
                    _buildInstruction(6, 'Konfirmasi dan selesaikan transfer'),
                    _buildInstruction(7, 'Simpan bukti transfer untuk referensi'),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.qr_code_2, color: Colors.purple[600], size: 24),
                        const SizedBox(width: 8),
                        Text(
                          'Pembayaran QRIS',
                          style: TextStyle(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.account_balance_wallet, color: Colors.teal[600], size: 24),
                        const SizedBox(width: 8),
                        Text(
                          'Pembayaran E-wallet',
                          style: TextStyle(
                    ...
                    _buildInstruction(3, 'Cari merchant "PT Azza Service Indonesia"'),
                        ...
                        Navigator.pushReplacement(
                          ...
                          MaterialPageRoute(
                            builder: (context) => StruckPesananPage(
                              serviceType: 'shop',
                              nama: widget.selectedAddress?['nama'] ?? 'Customer',
                              ...
                              alamat: widget.selectedAddress?['detailAlamat'] ?? 'Atur alamat anda di sini',
